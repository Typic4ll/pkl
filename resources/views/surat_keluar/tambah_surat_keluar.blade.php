  ...
  <main id="main" class="main">
    <section class="section dashboard">
        <div class="card">
            ...
            <form action="{{ url('/simpan-surat-keluar') }}" method="post" enctype="multipart/form-data" class="row g-3">
                {{ csrf_field() }}
                @if ($errors->any())
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="tujuan_surat" placeholder="Masukkan Tujuan Surat" class="form-control"  autocomplete="off">
                </div> 
                <div class="col-12">
